...
export function VoiceChat({
  ...
  return (
    <div className={cn("flex flex-col items-center justify-center min-h-full bg-background relative overflow-hidden rounded-xl", className)}>
      {/* Ambient particles */}
        ...
        >
          <motion.button
            ...
            className={cn(
              ...
              "border-border hover:border-primary/50 bg-zinc-900"
            )}
            animate={{
